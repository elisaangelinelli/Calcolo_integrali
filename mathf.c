/*! @file mathf.c
    @brief Definitions of the fuctions
...
*/
void Rectangular(float* values, int size, float stepsize, float* integ1, float* integ2) /*passaggio per reference poiché altrimenti dovevamo fare una struct*/{
